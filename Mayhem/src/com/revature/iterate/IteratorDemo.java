...
public class IteratorDemo {
	 ...
	 * AKA they implement the Iterable interface every collection has an iterator that allows traversal 
	 * between elements and allows safe removal of elements in place
	 */
	...
	public static void main(String[] args) {
		...
		//Modify Objects that are being iterated
